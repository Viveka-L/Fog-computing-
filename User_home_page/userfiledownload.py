        ...
        if(cursor.execute(existsquery)==0):
            print("<script>alert('Session is Not Available');location.href='../index.py';</script>")
                ...
                for row in res:
                    ...
                    print("<form action='usercandownload.py' method='post'>")
                    print("<tr><td>%s</td><td>%s</td>"%(fileid,userid))
                    print("<td>%s</td><td>%s</td>"%(username,filename))
                    print("<td>%s</td>"%(uploadedon))
                    print("<td><input type='text' name='seccode' placeholder='Enter Security Code' style='color:#000000;'>")
                    print("<input type='hidden' name='fileid' value='%s'>"%(fileid))
                    print("<input type='hidden' name='userid' value='%s'>"%(userid))
                    print("<input type='hidden' name='sname' value='%s'>"%(sessname))
                    print("<input type='hidden' name='stype' value='%s'>"%(sesstype))
                    print("</td>")
